...
.method public static key(Lokhttp3/HttpUrl;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lokio/ByteString;->aW(Ljava/lang/String;)Lokio/ByteString;

    move-result-object p0

    invoke-virtual {p0}, Lokio/ByteString;->fR()Lokio/ByteString;
...
.method static readInt(Lokio/e;)I
    ...
    .line 722
    :try_start_0
    invoke-interface {p0}, Lokio/e;->fG()J

    move-result-wide v0

    .line 723
    invoke-interface {p0}, Lokio/e;->fJ()Ljava/lang/String;
