...
.method constructor <init>(Lokio/e;Z)V
    ...
    invoke-direct {p1, p2}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lokio/e;)V
    ...
    invoke-direct {p1, v0, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILokio/q;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    invoke-interface {p1, p2, p3}, Lokio/e;->t(J)V
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 326
    sget-object p3, Lokio/ByteString;->As:Lokio/ByteString;
    ...
    invoke-interface {p3, v1, v2}, Lokio/e;->o(J)Lokio/ByteString;
...
.method public nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v1, v2, v3}, Lokio/e;->l(J)V
    :try_end_0
    ...
    invoke-interface {p1, v0, v1}, Lokio/e;->t(J)V
...
.method public readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    invoke-interface {p1, v3, v4}, Lokio/e;->o(J)Lokio/ByteString;
