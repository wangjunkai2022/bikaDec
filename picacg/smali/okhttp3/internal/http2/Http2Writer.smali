...
.method constructor <init>(Lokio/d;Z)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lokio/c;

    invoke-direct {p1, p2}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(Lokio/c;)V
...
.method private static writeMedium(Lokio/d;I)V
    ...
    .line 283
    invoke-interface {p0, v0}, Lokio/d;->at(I)Lokio/d;
    ...
    .line 285
    invoke-interface {p0, p1}, Lokio/d;->at(I)Lokio/d;
...
.method public declared-synchronized connectionPreface()V
    ...
    invoke-virtual {v4}, Lokio/ByteString;->fU()Ljava/lang/String;
    ...
    invoke-interface {v0, v1}, Lokio/d;->k([B)Lokio/d;
...
.method public frameHeader(IIBB)V
    ...
    invoke-interface {p2, p1}, Lokio/d;->ar(I)Lokio/d;
...
.method public declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lokio/d;->ar(I)Lokio/d;
    ...
    invoke-interface {p1, p2}, Lokio/d;->ar(I)Lokio/d;
    ...
    invoke-interface {p1, p3}, Lokio/d;->k([B)Lokio/d;
...
.method public declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lokio/d;->ar(I)Lokio/d;
...
.method public declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    invoke-interface {p3, p2}, Lokio/d;->ar(I)Lokio/d;
...
.method public declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    invoke-interface {v3, v0}, Lokio/d;->as(I)Lokio/d;
    ...
    invoke-interface {v0, v3}, Lokio/d;->ar(I)Lokio/d;
