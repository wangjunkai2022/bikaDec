...
.method public static http2HeadersList(Lokhttp3/Request;)Ljava/util/List;
    ...
    invoke-static {v3}, Lokio/ByteString;->aW(Ljava/lang/String;)Lokio/ByteString;
...
.method public static readHttp2HeadersList(Ljava/util/List;)Lokhttp3/Response$Builder;
    ...
    invoke-virtual {v5}, Lokio/ByteString;->fP()Ljava/lang/String;
    ...
    invoke-virtual {v6}, Lokio/ByteString;->fP()Ljava/lang/String;
...
.method public createRequestBody(Lokhttp3/Request;J)Lokio/p;
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->getSink()Lokio/p;
...
.method public writeRequestHeaders(Lokhttp3/Request;)V
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->readTimeout()Lokio/r;
    ...
    invoke-virtual {p1, v0, v1, v2}, Lokio/r;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/r;

    .line 108
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Codec;->stream:Lokhttp3/internal/http2/Http2Stream;

    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->writeTimeout()Lokio/r;
