...
.method private newJournalWriter()Lokio/d;
    ...
    .line 322
    invoke-static {v1}, Lokio/k;->b(Lokio/p;)Lokio/d;
...
.method declared-synchronized completeEdit(Lokhttp3/internal/cache/DiskLruCache$Editor;Z)V
    ...
    invoke-interface {p1, v3}, Lokio/d;->at(I)Lokio/d;
...
.method declared-synchronized edit(Ljava/lang/String;J)Lokhttp3/internal/cache/DiskLruCache$Editor;
    ...
    invoke-interface {p2, p3}, Lokio/d;->aV(Ljava/lang/String;)Lokio/d;

    move-result-object p2

    const/16 p3, 0x20

    invoke-interface {p2, p3}, Lokio/d;->at(I)Lokio/d;

    move-result-object p2

    invoke-interface {p2, p1}, Lokio/d;->aV(Ljava/lang/String;)Lokio/d;
...
.method public declared-synchronized get(Ljava/lang/String;)Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v1, p1}, Lokio/d;->aV(Ljava/lang/String;)Lokio/d;

    move-result-object p1

    const/16 v1, 0xa

    invoke-interface {p1, v1}, Lokio/d;->at(I)Lokio/d;
...
.method declared-synchronized rebuildJournal()V
    ...
    invoke-static {v0}, Lokio/k;->b(Lokio/p;)Lokio/d;
    ...
    .line 406
    invoke-interface {v0, v4}, Lokio/d;->aV(Ljava/lang/String;)Lokio/d;

    move-result-object v4

    invoke-interface {v4, v5}, Lokio/d;->at(I)Lokio/d;

    .line 407
    iget-object v3, v3, Lokhttp3/internal/cache/DiskLruCache$Entry;->key:Ljava/lang/String;

    invoke-interface {v0, v3}, Lokio/d;->aV(Ljava/lang/String;)Lokio/d;
...
.method removeEntry(Lokhttp3/internal/cache/DiskLruCache$Entry;)Z
    ...
    invoke-interface {v0, v2}, Lokio/d;->aV(Ljava/lang/String;)Lokio/d;
