...
.method private readControlFrame()V
    ...
    invoke-interface {v1, v0, v2, v3}, Lokio/e;->a(Lokio/c;J)V
    ...
    invoke-virtual {v0, v5, v4, v1}, Lokio/c;->a([BII)Lokio/c;
...
.method private readHeader()V
    ...
    invoke-interface {v2}, Lokio/e;->timeout()Lokio/r;

    move-result-object v2

    invoke-virtual {v2}, Lokio/r;->clearTimeout()Lokio/r;
    ...
    invoke-interface {v3}, Lokio/e;->timeout()Lokio/r;

    move-result-object v3

    sget-object v4, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v3, v0, v1, v4}, Lokio/r;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/r;
...
.method private readMessage(Lokio/c;)V
    ...
    invoke-virtual {p1, v0, v1, v2}, Lokio/c;->a([BII)Lokio/c;
...
.method private readMessageFrame()V
    ...
    .line 219
    invoke-direct {p0, v2}, Lokhttp3/internal/ws/WebSocketReader;->readMessage(Lokio/c;)V
    ...
    invoke-virtual {v2}, Lokio/c;->fI()Ljava/lang/String;
