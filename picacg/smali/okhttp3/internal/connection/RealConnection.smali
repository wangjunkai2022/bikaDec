...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    .line 345
    :cond_0
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)Lokio/q;
    ...
    invoke-static {v0, v1, v2}, Lokhttp3/internal/Util;->skipAll(Lokio/q;ILjava/util/concurrent/TimeUnit;)Z
    ...
    invoke-interface {p1}, Lokio/e;->fx()Lokio/c;

    move-result-object p1

    invoke-virtual {p1}, Lokio/c;->fB()Z
    ...
    invoke-interface {p1}, Lokio/d;->fx()Lokio/c;
...
.method private establishProtocol(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:Lokio/d;

    invoke-virtual {p1, v0, v1, v2, v3}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;Lokio/e;Lokio/d;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public newCodec(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    invoke-virtual {v0, v1, v2, v3}, Lokio/r;->timeout(JLjava/util/concurrent/TimeUnit;)Lokio/r;
