...
.method private readCertificateList(Lokio/e;)Ljava/util/List;
    ...
    .line 665
    invoke-interface {p1}, Lokio/e;->fJ()Ljava/lang/String;
    ...
    .line 667
    invoke-static {v4}, Lokio/ByteString;->aY(Ljava/lang/String;)Lokio/ByteString;
    ...
    .line 668
    invoke-virtual {v5}, Lokio/c;->fC()Ljava/io/InputStream;
...
.method private writeCertList(Lokio/d;Ljava/util/List;)V
    ...
    invoke-interface {p1, v0, v1}, Lokio/d;->y(J)Lokio/d;
    ...
    .line 680
    invoke-interface {v0, v1}, Lokio/d;->at(I)Lokio/d;
    ...
    .line 683
    invoke-static {v3}, Lokio/ByteString;->l([B)Lokio/ByteString;

    move-result-object v3

    invoke-virtual {v3}, Lokio/ByteString;->fQ()Ljava/lang/String;

    move-result-object v3

    .line 684
    invoke-interface {p1, v3}, Lokio/d;->aV(Ljava/lang/String;)Lokio/d;

    move-result-object v3

    .line 685
    invoke-interface {v3, v1}, Lokio/d;->at(I)Lokio/d;
    :try_end_0
...
.method public writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-static {p1}, Lokio/k;->b(Lokio/p;)Lokio/d;
    ...
    invoke-interface {p1, v1}, Lokio/d;->aV(Ljava/lang/String;)Lokio/d;
    ...
    .line 611
    invoke-interface {v1, v2}, Lokio/d;->at(I)Lokio/d;
    ...
    invoke-interface {p1, v3, v4}, Lokio/d;->y(J)Lokio/d;
    ...
    invoke-interface {p1, v4}, Lokio/d;->aV(Ljava/lang/String;)Lokio/d;
    ...
    .line 618
    invoke-interface {v4, v5}, Lokio/d;->aV(Ljava/lang/String;)Lokio/d;
    ...
    .line 620
    invoke-interface {v4, v2}, Lokio/d;->at(I)Lokio/d;
    ...
    .line 629
    invoke-interface {v3, v4}, Lokio/d;->aV(Ljava/lang/String;)Lokio/d;
    ...
    .line 631
    invoke-interface {v3, v2}, Lokio/d;->at(I)Lokio/d;
    ...
    invoke-interface {p1, v0}, Lokio/d;->aV(Ljava/lang/String;)Lokio/d;
    ...
    .line 635
    invoke-interface {v0, v3, v4}, Lokio/d;->y(J)Lokio/d;

    move-result-object v0

    .line 636
    invoke-interface {v0, v2}, Lokio/d;->at(I)Lokio/d;
    ...
    .line 643
    invoke-interface {p1, v2}, Lokio/d;->at(I)Lokio/d;
