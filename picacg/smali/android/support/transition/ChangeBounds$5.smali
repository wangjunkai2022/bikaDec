.class Landroid/support/transition/ChangeBounds$5;
...
.method constructor <init>(Landroid/support/transition/ChangeBounds;Landroid/view/ViewGroup;Landroid/graphics/drawable/BitmapDrawable;Landroid/view/View;F)V
    ...
    .line 359
    iput-object p1, p0, Landroid/support/transition/ChangeBounds$5;->this$0:Landroid/support/transition/ChangeBounds;

    iput-object p2, p0, Landroid/support/transition/ChangeBounds$5;->val$sceneRoot:Landroid/view/ViewGroup;

    iput-object p3, p0, Landroid/support/transition/ChangeBounds$5;->val$drawable:Landroid/graphics/drawable/BitmapDrawable;

    iput-object p4, p0, Landroid/support/transition/ChangeBounds$5;->val$view:Landroid/view/View;

    iput p5, p0, Landroid/support/transition/ChangeBounds$5;->val$transitionAlpha:F
...
.method public onAnimationEnd(Landroid/animation/Animator;)V
    ...
    .line 362
    iget-object p1, p0, Landroid/support/transition/ChangeBounds$5;->val$sceneRoot:Landroid/view/ViewGroup;
    ...
    iget-object v0, p0, Landroid/support/transition/ChangeBounds$5;->val$drawable:Landroid/graphics/drawable/BitmapDrawable;

    invoke-interface {p1, v0}, Landroid/support/transition/ViewOverlayImpl;->remove(Landroid/graphics/drawable/Drawable;)V

    .line 363
    iget-object p1, p0, Landroid/support/transition/ChangeBounds$5;->val$view:Landroid/view/View;

    iget v0, p0, Landroid/support/transition/ChangeBounds$5;->val$transitionAlpha:F
