...
public class AudioAttributesCompat {
    ...
    public boolean equals(Object obj) {
        ...
        if (Build.VERSION.SDK_INT < 21 || sForceLegacyBehavior || this.mAudioAttributesWrapper == null) {
            return this.mContentType == audioAttributesCompat.getContentType() && this.mFlags == audioAttributesCompat.getFlags() && this.mUsage == audioAttributesCompat.getUsage() && this.mLegacyStream == audioAttributesCompat.mLegacyStream;
        }
