...
public final class MediaControllerCompat {
    ...
    public static abstract class Callback implements IBinder.DeathRecipient {
        ...
        private class StubCompat extends IMediaControllerCallback.Stub {
            ...
            public void onCaptioningEnabledChanged(boolean z) throws RemoteException {
                Callback.this.mHandler.post(11, Boolean.valueOf(z), null);
            }
    ...
    static class MediaControllerImplApi21 implements MediaControllerImpl {
        ...
        public class ExtraCallback extends IMediaControllerCallback.Stub {
            ...
            @Override // android.support.v4.media.session.IMediaControllerCallback
            public void onCaptioningEnabledChanged(final boolean z) throws RemoteException {
                this.mCallback.mHandler.post(new Runnable() { // from class: android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi21.ExtraCallback.3
                    @Override // java.lang.Runnable
                    public void run() {
                        ExtraCallback.this.mCallback.onCaptioningEnabledChanged(z);
                    }
                });
            }
            ...
            public void onShuffleModeChanged(final boolean z) throws RemoteException {
                this.mCallback.mHandler.post(new Runnable() { // from class: android.support.v4.media.session.MediaControllerCompat.MediaControllerImplApi21.ExtraCallback.5
                    @Override // java.lang.Runnable
                    public void run() {
