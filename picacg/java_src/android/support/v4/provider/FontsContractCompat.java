...
public class FontsContractCompat {
    ...
    private static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() { // from class: android.support.v4.provider.FontsContractCompat.2
    ...
    public static void requestFont(@NonNull final Context context, @NonNull final FontRequest fontRequest, @NonNull final FontRequestCallback fontRequestCallback, @NonNull Handler handler) {
        ...
        handler.post(new Runnable() { // from class: android.support.v4.provider.FontsContractCompat.1
                ...
                try {
                    ...
                    if (fetchFonts.getStatusCode() != 0) {
                        switch (fetchFonts.getStatusCode()) {
                            case 1:
                                handler2.post(new Runnable() { // from class: android.support.v4.provider.FontsContractCompat.1.2
                                    @Override // java.lang.Runnable
                                    public void run() {
                                ...
                                return;
                            case 2:
                                handler2.post(new Runnable() { // from class: android.support.v4.provider.FontsContractCompat.1.3
                                    @Override // java.lang.Runnable
                                    public void run() {
                                ...
                                return;
                            default:
                                handler2.post(new Runnable() { // from class: android.support.v4.provider.FontsContractCompat.1.4
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        fontRequestCallback.onTypefaceRequestFailed(-3);
                                    }
                    ...
                    if (fonts == null || fonts.length == 0) {
                        handler2.post(new Runnable() { // from class: android.support.v4.provider.FontsContractCompat.1.5
                            @Override // java.lang.Runnable
                            public void run() {
                    ...
                    for (FontInfo fontInfo : fonts) {
                        if (fontInfo.getResultCode() != 0) {
                            ...
                            if (resultCode < 0) {
                                handler2.post(new Runnable() { // from class: android.support.v4.provider.FontsContractCompat.1.6
                                    @Override // java.lang.Runnable
                                    public void run() {
                                        fontRequestCallback.onTypefaceRequestFailed(-3);
                                    }
                                ...
                                handler2.post(new Runnable() { // from class: android.support.v4.provider.FontsContractCompat.1.7
                                    @Override // java.lang.Runnable
                                    public void run() {
                    ...
                    if (buildTypeface == null) {
                        handler2.post(new Runnable() { // from class: android.support.v4.provider.FontsContractCompat.1.8
                            @Override // java.lang.Runnable
                            public void run() {
                                fontRequestCallback.onTypefaceRequestFailed(-3);
                            }
                        ...
                        handler2.post(new Runnable() { // from class: android.support.v4.provider.FontsContractCompat.1.9
                            @Override // java.lang.Runnable
                            public void run() {
                    ...
                    handler2.post(new Runnable() { // from class: android.support.v4.provider.FontsContractCompat.1.1
                        @Override // java.lang.Runnable
                        public void run() {
                            fontRequestCallback.onTypefaceRequestFailed(-1);
                        }
                ...
                if (!hashMap.containsKey(uri)) {
                    ...
                    try {
                        if (Build.VERSION.SDK_INT > 19) {
                            openFileDescriptor = contentResolver.openFileDescriptor(uri, "r", cancellationSignal);
                        } else {
    ...
    public static Typeface buildTypeface(@NonNull Context context, @Nullable CancellationSignal cancellationSignal, @NonNull FontInfo[] fontInfoArr) {
        return TypefaceCompat.createTypeface(context, fontInfoArr, prepareFontData(context, fontInfoArr, cancellationSignal)).getTypeface();
    }
